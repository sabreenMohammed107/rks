...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">العقود والشهادات </h3>
      <a href="{{ route('admin-contract.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td><img src="{{ asset('uploads/contracts') }}/{{ $row->image }}" width="100" height="100"> </td>
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin-contract.edit', $row->id) }}">
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('admin-contract.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
