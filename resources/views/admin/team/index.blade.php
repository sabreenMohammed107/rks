...
<div class="box">
    <div class="box-header">
      <h3 class="box-title">فريق العمل</h3>
      <a href="{{ route('admin-team.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
                ...
                data-show-export="true" data-locale="ar-SA"  style="direction: rtl" >
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td>{!! $row->position_ar !!} </td>
                                <td><img src="{{ asset('uploads/teams') }}/{{ $row->image }}" width="100" height="100"> </td>
