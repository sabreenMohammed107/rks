    ...
    <div class="container">
      <div class="row no-gutters slider-text align-items-center justify-content-center dir" >
        <div class="col-md-9 ftco-animate text-center">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="{{ LaravelLocalization::localizeUrl('/') }}">{{ __('links.home') }} / </a></span> <span>{{ __('links.experance') }} <i class="ion-ios-arrow-forward"></i></span></p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="ftco-section">
    <div class="container">
        ...
        <div class="col-lg-8 ftco-animate ">
            <p>
                <img src="{{asset('uploads/services')}}/{{$service->image}}" alt="" class="img-fluid blog-img2 w-100">
            </p>
